...
const showAllGroups = async (params) => {
  try {
    const response = await axiosInstance.post('/showAllGroups', params)
    return response.data
  } catch (error) {
    throw error
  }
...
export { createGroup, inviteGroup, checkGroupName, showAllGroups }
